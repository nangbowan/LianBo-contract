...
if (assemblyscriptPath) {
  ...
  assemblyscriptPath = require.resolve("@antchain/deps/assemblyscript");
  ascPath = require.resolve("@antchain/deps/assemblyscript/cli/asc");
  transformerPath = require.resolve("@antchain/deps/assemblyscript/cli/transform");
}
